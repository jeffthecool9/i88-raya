...
const DAILY_REWARDS = [
  ...
  { day: 7, date: '25 Mar', bonus: 'Get up to RM588', spins:  highlight: true, isCTA: true },
];
      ...
      <Section id="rewards" className="bg-gradient-to-b from-transparent to-raya-emerald/10">
        ...
        <div className="mt-12 md:mt-20 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            >
              <Zap className="w-3 h-3 fill-raya-gold" /> Total Deposit Rewards{' '}
              <Zap className="w-3 h-3 fill-raya-gold" />
            </motion.div>
            ...
            {STREAK_BONUSES.map((streak, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-5">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center ${streak.color} group-hover:scale-110 transition-transform duration-500`}
                  >
                ...
                <div className="mt-6 h-1 w-full bg-white/5 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className={`h-full bg-gradient-to-r from-transparent ${streak.color.replace(
                      'text-',
                      'to-'
                    )}`}
                  />
